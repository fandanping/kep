module.exports = {
    SELECT_TOPIC_LIST: 'select t.id,title,page_view,reply_num,user_name,category from topic t,user u where u.id=t.user_id',
    SELECT_TOPIC_LIST_BY_CATEGORY: 'select t.id,title,page_view,reply_num,user_name from topic t,user u where u.id=t.user_id and category=?',
